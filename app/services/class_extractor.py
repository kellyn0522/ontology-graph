...
아래 문서를 기반으로
문서의 핵심 Entity 및 Ontology Class를 추출하세요.

[목표]

- 문서의 핵심 개체(Entity)와 개념(Concept)을 추출하세요.
- 조직, 시스템, 문서, 프로젝트, 사용자, 부서, 제품, 서비스 등
  실제 비즈니스 구조의 중심 개념을 우선적으로 추출하세요.
...
- 유사 의미는 하나로 통합하세요.
- isolated node가 생기지 않도록
  서로 연결 가능한 핵심 개념 중심으로 생성하세요.
